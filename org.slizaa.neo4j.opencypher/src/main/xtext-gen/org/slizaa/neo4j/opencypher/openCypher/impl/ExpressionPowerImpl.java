 ...
 * </p>
 * <ul>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.impl.ExpressionPowerImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.impl.ExpressionPowerImpl#getOperator <em>Operator</em>}</li>
...
public class ExpressionPowerImpl extends ExpressionImpl implements ExpressionPower
{
  ...
  public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenCypherPackage.EXPRESSION_POWER__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(Expression newLeft)
  {
    if (newLeft != left)
    {
      ...
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.EXPRESSION_POWER__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.EXPRESSION_POWER__LEFT, null, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.EXPRESSION_POWER__LEFT, newLeft, newLeft));
  }
  ...
  public void setOperator(String newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.EXPRESSION_POWER__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OpenCypherPackage.EXPRESSION_POWER__LEFT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OpenCypherPackage.EXPRESSION_POWER__LEFT:
        return getLeft();
      case OpenCypherPackage.EXPRESSION_POWER__OPERATOR:
        return getOperator();
      case OpenCypherPackage.EXPRESSION_POWER__RIGHT:
        return getRight();
    }
