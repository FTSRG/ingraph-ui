 ...
 * </p>
 * <ul>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.StandaloneCall#getInvocation <em>Invocation</em>}</li>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.StandaloneCall#getYieldItems <em>Yield Items</em>}</li>
 * </ul>
 *
 * @see org.slizaa.neo4j.opencypher.openCypher.OpenCypherPackage#getStandaloneCall()
 * @model
 * @generated
 */
public interface StandaloneCall extends Query
{
   ...
   * @see org.slizaa.neo4j.opencypher.openCypher.OpenCypherPackage#getStandaloneCall_Invocation()
  ...
  /**
   * Sets the value of the '{@link org.slizaa.neo4j.opencypher.openCypher.StandaloneCall#getInvocation <em>Invocation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.slizaa.neo4j.opencypher.openCypher.OpenCypherPackage#getStandaloneCall_YieldItems()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.slizaa.neo4j.opencypher.openCypher.StandaloneCall#getYieldItems <em>Yield Items</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
