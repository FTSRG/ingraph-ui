...
import org.slizaa.neo4j.opencypher.formatting2.OpenCypherFormatter;
import org.slizaa.neo4j.opencypher.generator.OpenCypherGenerator;
import org.slizaa.neo4j.opencypher.parser.antlr.OpenCypherAntlrTokenFileProvider;
import org.slizaa.neo4j.opencypher.parser.antlr.OpenCypherParser;
import org.slizaa.neo4j.opencypher.parser.antlr.lexer.InternalOpenCypherLexer;
import org.slizaa.neo4j.opencypher.scoping.OpenCypherScopeProvider;
import org.slizaa.neo4j.opencypher.serializer.OpenCypherSemanticSequencer;
import org.slizaa.neo4j.opencypher.serializer.OpenCypherSyntacticSequencer;
import org.slizaa.neo4j.opencypher.services.OpenCypherGrammarAccess;
import org.slizaa.neo4j.opencypher.validation.OpenCypherValidator;
...
public abstract class AbstractOpenCypherRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/slizaa/neo4j/opencypher/OpenCypher.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.slizaa.neo4j.opencypher.OpenCypher");
	}
	...
	public Class<? extends IFormatter2> bindIFormatter2() {
		return OpenCypherFormatter.class;
	}
