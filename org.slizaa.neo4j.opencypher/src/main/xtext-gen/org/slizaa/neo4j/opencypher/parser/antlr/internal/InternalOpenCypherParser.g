...
@after {
	...
	(
		...
		{
			$current = $this_InQueryCall_12.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_ExpressionComparison_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_CaseExpression_10.current;
			afterParserOrEnumRuleCall();
		}
		    |
		(
		...
		{
			$current = $this_MapLiteral_16.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ListComprehension_17.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_PatternComprehension_18.current;
			afterParserOrEnumRuleCall();
		}
		    |
		(
...
@after {
	...
	{
		$current = $this_ProcedureName_0.current;
		afterParserOrEnumRuleCall();
	}
;
